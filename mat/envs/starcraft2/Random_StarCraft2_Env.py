...
class RandomStarCraft2Env(MultiAgentEnv):
    ...
    def __init__(
        ...
        self.obs_agent_id = obs_agent_id                    # added
        self.state_pathing_grid = state_pathing_grid        # added
        self.state_terrain_height = state_terrain_height    # added
        ...
        # add for randomizing
        self.agent_permutation = None       # added
        self.agent_recovery = None          # added
