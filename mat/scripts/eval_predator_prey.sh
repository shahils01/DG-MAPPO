...
exp="${EXP:-eval}"
seed="${SEED:-1}"
model_dir="${MODEL_DIR:-/home/shahils/Desktop/gitBackupRepo/DG-MAPPO/mat/scripts/results/long_range_predator_prey/LongRangePredatorPreyContinuous-v0/6pred_2prey/mat_dec/mat_dec/wandb/run-20260709_164720-nctacaiz/files/transformer_7100.pt}"

num_predators="${NUM_PREDATORS:-8}"
