...
def get_config():
    ...
    parser.add_argument("--algorithm_name", type=str,
                        ...
                        help="mappo: per-agent local actors and centralized critics; dg_mat: distributed graph-masked actor/critic with D-SGD; mappo_dgnn: distributed GNN with consensus loss; mappo_gnn: shared trunk GNN with consensus loss; mappo_dgnn_dsgd: distributed GNN with D-SGD; consensus_ippo: IPPO with graph-neighbor critic consensus; dgn: DGN graph-attention baseline")
    ...
    parser.add_argument("--mini_batch_size", type=int, default=1024,
                        help='mini batch size for ppo (default: 1024)')
    ...
    parser.add_argument(
        ...
        choices=("gat", "gatv2"),
        default="gat",
        help="Graph-attention scoring used by GNN_Model (default: gat).",
    )
    parser.add_argument("--lambd-gnn", type=float, default=1.0,) # Decay Weighting for GCNII and AERO-GNN
    ...
    parser.add_argument("--use_CNN_for_pi", type=bool, default=False, help="by default False, whether to use CNN to pre process policy parameters.")
    parser.add_argument("--use_VAE_for_pi", type=bool, default=True, help="by default False, whether to use VAE to pre process policy parameters.")
